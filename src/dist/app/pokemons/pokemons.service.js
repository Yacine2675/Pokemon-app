...
let PokemonsService = class PokemonsService {
    ...
    searchPokemons(term) {
        ...
        return this.http.get(`api/pokemons/?name=${term}`).pipe(operators_1.tap(_ => this.log(`found pokemons matching "${term}"`)), operators_1.catchError(this.handleError('searchPokemons', [])));
    }
